> **Source:** Perplexity, 2026-09-03. Prompt: expand Vend into a vending-machine sim (autonomous customers, rent, suppliers) with human+AI as the player.
> **This file is the original dump.** Judge it; do not treat rent=5 as live (Vend now uses rent 20 + cooling 4).
> Companions: `COMPARISON.md`, `gemini-micro-retail.md`.
