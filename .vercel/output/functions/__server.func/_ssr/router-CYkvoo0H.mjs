...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CYkvoo0H.js
var router_CYkvoo0H_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DYipz2bB.css";
var APP_NAME = "Vend";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Closed play-money shop. Chat cannot move balances — only the ledger can."
			},
			{
				name: "theme-color",
				content: "#0c1014"
...
var $$splitComponentImporter = () => import("./routes-D5Rb0i4X.mjs");
...
//#endregion
export { getRouter, router_CYkvoo0H_exports as t };
