...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CCI2lY0_.mjs");
...
var manifest = {
	"09704baf5acdbc2d802529ca746fb1666e1feae4b20365e2d97910340b01be42": {
		functionName: "priceSku_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"301d8e90a687bc8c68466afc2e858277c180ab627bc2bd75b7b1de738f12c297": {
		functionName: "restockSku_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"34c8a57eaae35b4b68912f356000bc815cd68adf5b75ca5a016aaa371c758969": {
		functionName: "replyCustomer_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"3ffdc9d24aff19e98014627b26cd136c007714096cd4a530d1819595a8ff2f6a": {
		functionName: "getWorld_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"56dada28921e1fcd5e168752e1b81aba365f6488f359f6f6f8e5d4b9f1b5078e": {
		functionName: "advanceDay_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"98a77df801803675381c8255c4fcaf0554a2de0f59d2f6a4e08d1e4129633ff2": {
		functionName: "runDummy_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"d7335b4c6c0aafa80b7dcc884a5c457706ad7aeffb91c41a3ec72be7fa26f45d": {
		functionName: "sendHaggle_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	},
	"fb01c996e696138603064c797de1e654bee7c74f616c49e9e11546efb28c9dfc": {
		functionName: "buyItem_createServerFn_handler",
		importer: () => import("./api-CFdVRolN.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CYkvoo0H.mjs").then((n) => n.t),
